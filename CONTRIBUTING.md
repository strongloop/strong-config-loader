...
Thank you for your interest in `strong-config-loader`, an open source project
administered by StrongLoop.

Contributing to `strong-config-loader` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-config-loader)
